...
<head>
  ...
  <title>Stock Report - PT. Dorareta Indo Makmur</title>
  ...
  <script src="../js/report-stock.js" defer></script>
</head>
  ...
  <main class="px-4 pt-28 pb-10 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-col lg:flex-row lg:justify-between lg:items-end gap-4 mb-6">
      <div class="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
        <div>
          <label for="filterCategory" class="block text-sm font-medium mb-1">Kategori</label>
          <input type="text" id="filterCategory" placeholder="Nama kategori"
        ...
        <div class="mt-6 sm:mt-5">
          <button id="resetFilters"
            class="text-sm px-4 py-2 rounded-md bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white hover:bg-gray-300 dark:hover:bg-gray-600">
            Reset
          </button>
        </div>
      </div>
...
<div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-x-auto">
  <table id="stockReportTable" class="min-w-full text-sm table-auto">
    <thead class="bg-gray-100 dark:bg-gray-700 text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">
      <tr>
        <th class="px-4 py-3 text-left whitespace-nowrap w-32">Code</th>
        <th class="px-4 py-3 text-left whitespace-nowrap w-64">Product</th>
        <th class="px-4 py-3 text-left whitespace-nowrap w-48">Category</th>
        <th class="px-4 py-3 text-center whitespace-nowrap w-20">Stock</th>
        <th class="px-4 py-3 text-center whitespace-nowrap w-24">Minimum</th>
        <th class="px-4 py-3 text-center whitespace-nowrap w-32">Status</th>
      </tr>
    </thead>
        ...
        <div class="relative">
          <select id="rowsPerPage"
            class="appearance-none px-2 py-1 pr-8 rounded-md bg-transparent border border-transparent
                   text-gray-800 dark:text-white focus:outline-none cursor-pointer [&>option]:text-black">
