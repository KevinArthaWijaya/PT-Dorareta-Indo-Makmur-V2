...
<head>
  ...
  <title>Sales Report - PT. Dorareta Indo Makmur</title>
  ...
  <script src="../js/report-sales.js" defer></script>
</head>
  ...
  <main class="px-4 pt-28 pb-10 sm:px-6 lg:px-8">
    ...
    <div class="w-full mb-5">
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-2">
        <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">Sales Report</h2>
        <div class="text-sm text-gray-500 dark:text-gray-300">
          <a href="../dashboard/dashboard.php" class="text-gray-600 dark:text-gray-200 hover:underline">Dashboard</a>
          <span class="mx-1">/</span>
          <span class="text-red-600 font-semibold">Sales Report</span>
        </div>
      </div>
...
<div class="flex flex-col lg:flex-row lg:justify-between lg:items-end gap-4 mb-6">
  <div class="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
    ...
    <div>
      <label for="filterCustomer" class="block text-sm font-medium mb-1">Customer</label>
  ...
  <div class="flex gap-3">
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-x-auto">
      <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm" id="salesReportTable">
        <thead class="bg-gray-100 dark:bg-gray-700 text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">
          <tr>
            <th class="px-4 py-3 text-left cursor-pointer" data-sort="invoice">Invoice</th>
            <th class="px-4 py-3 text-left cursor-pointer" data-sort="date">Tanggal</th>
            <th class="px-4 py-3 text-left cursor-pointer" data-sort="customer">Customer</th>
            <th class="px-4 py-3 text-left cursor-pointer" data-sort="status">Status</th>
            <th class="px-4 py-3 text-left cursor-pointer" data-sort="total">Total</th>
            <th class="px-4 py-3 text-left cursor-pointer" data-sort="paid">Paid</th>
            <th class="px-4 py-3 text-left cursor-pointer" data-sort="due">Due</th>
            <th class="px-4 py-3 text-left cursor-pointer" data-sort="payment_status">Pembayaran</th>
          </tr>
        </thead>
