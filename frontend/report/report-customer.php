...
<head>
  ...
  <title>Customer Report - PT. Dorareta Indo Makmur</title>
  <link href="../../src/output.css" rel="stylesheet" />
  <link href="../css/header.css" rel="stylesheet" />
  <script src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js"></script>
  <script src="../js/header.js" defer></script>
  <script src="../js/logout.js" defer></script>
  <script src="../js/report-customer.js" defer></script>
</head>
  ...
  <main class="px-4 pt-28 pb-10 sm:px-6 lg:px-8">
    ...
    <div class="w-full mb-5">
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-2">
        <h2 class="text-2xl font-semibold text-gray-900 dark:text-white">Customer Report</h2>
        <div class="text-sm text-gray-500 dark:text-gray-300">
          <a href="../dashboard/dashboard.php" class="text-gray-600 dark:text-gray-200 hover:underline">Dashboard</a>
          <span class="mx-1">/</span>
          <span class="text-red-600 font-semibold">Customer Report</span>
        </div>
      </div>
...
<div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-x-auto">
  <table id="customerReportTable" class="min-w-full text-sm table-auto">
    <thead class="bg-gray-100 dark:bg-gray-700 text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">
      <tr>
        ...
        <th class="px-4 py-3 text-center">Last Purchase</th>
      </tr>
    </thead>
